...
| Hex Opcode | Decimal | Binary | Binary (no spaces) | Mnemonic |
|------------|---------|--------|--------------------|----------|
...
- **Format**: `CMP dest, src`
- **Length**: 6 bytes
- **Operation**: Compute `reg[dest] - reg[src]`, update flags (`AZ`, `AE`, `AC`) only
- **Example**: `CMP AR, BR`
...
### PUSH_R — Push to Right Stack
- **Opcode**: `0x000D`
- **Format**: `PUSH_R reg`
- **Length**: 4 bytes
- **Operation**: `RSP--`, `stack[RSP] = reg`
- **Example**: `PUSH_R AR`

### PUSH_L — Push to Left Stack
- **Opcode**: `0x000E`
- **Format**: `PUSH_L reg`
- **Length**: 4 bytes
- **Operation**: `LSP--`, `stack[LSP] = reg`
- **Example**: `PUSH_L AR`

### POP_R — Pop from Right Stack
- **Opcode**: `0x000F`
- **Format**: `POP_R reg`
- **Length**: 4 bytes
- **Operation**: `reg = stack[RSP]`, `RSP++`
- **Example**: `POP_R AR`

### POP_L — Pop from Left Stack
- **Opcode**: `0x0010`
- **Format**: `POP_L reg`
- **Length**: 4 bytes
- **Operation**: `reg = stack[LSP]`, `LSP++`
- **Example**: `POP_L AR`
...
- **Format**: `SYSCALL`
- **Length**: 2 bytes
- **Operation**: Invoke kernel service based on `AR` (library) and `BR` (function)
- **Example**: `SYSCALL`
...
- **Format**: `NOP`
- **Length**: 2 bytes
- **Operation**: No operation, yield CPU (cooperative scheduling)
- **Example**: `NOP`
...
*Document Version: 1.0 | Updated: 2026-06-01 | Author: qpwq1 (XaoDingx)*
